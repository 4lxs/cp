...
signed main() {
  ...
  vector<tuple<int, int, int, int>> seats;
  seats.reserve(200000);

  for (int tx = 0, ty = 0, tbls = 0; tbls < 50000; tbls++) {
    seats.push_back({3 * tx + 3 * ty + 2, 3 * tx + 1, 3 * ty + 1, tbls});
    seats.push_back({3 * tx + 3 * ty + 3, 3 * tx + 1, 3 * ty + 2, tbls});
    seats.push_back({3 * tx + 3 * ty + 3, 3 * tx + 2, 3 * ty + 1, tbls});
    seats.push_back({3 * tx + 3 * ty + 6, 3 * tx + 2, 3 * ty + 2, tbls});
